                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">A New Flora</li>
                        </ol>
                    </nav>
                </div>
            </div>
				...
				<div class="wrapper row">
					<div class="preview col-md-5">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="https://lh3.google.com/u/0/d/14mIKP7zQhubGCGY-7gN_MW68jsTRQV2T=w1366-h608-iv1" /></div>
				  
						</div>
						<ul class="preview-thumbnail nav nav-tabs">
						  <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="https://lh3.google.com/u/0/d/14mIKP7zQhubGCGY-7gN_MW68jsTRQV2T=w1366-h608-iv1" /></a></li>
						  
						</ul>
						
					</div>
					<div class="details col-md-7">
						<h3 class="product-title">A New Flora</h3>
						<div class="variation">
							  <h4>Variations</h2>
							  <ul class="list-group mt-4 mb-4 w-50">
							    <li class="list-group-item">No Variation Available</li>
							  </ul>
						</div>
						<div class="action">
							<button type="button" class="btn btn-success add-to-cart" data-product="A New Flora" id="enquiryProduct" data-toggle="modal" data-target="#myModal">Enquiry</button>
