				...
				<div class="wrapper row">
					<div class="preview col-md-5">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="https://lh3.google.com/u/0/d/14mIKP7zQhubGCGY-7gN_MW68jsTRQV2T=w1366-h657-iv1" /></div>

						  
						</div>
						<ul class="preview-thumbnail nav nav-tabs">
						  <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="https://lh3.google.com/u/0/d/14mIKP7zQhubGCGY-7gN_MW68jsTRQV2T=w1366-h657-iv1" /></a></li>
					...
					<div class="details col-md-7">
						...
						<div class="variation">
							  ...
							  <ul class="list-group mt-4 mb-4 w-50">
							    <li class="list-group-item">No Varitaion Available</li>
