                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Wicker</li>
                        </ol>
                    </nav>
                </div>
            </div>
				...
				<div class="wrapper row">
					<div class="preview col-md-5">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="https://lh3.google.com/u/0/d/177h17kYoQEE5jI94Y7EjlS_8exZD9S18=w1280-h528-iv1" /></div>

						  
						</div>
						<ul class="preview-thumbnail nav nav-tabs">
						  <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="https://lh3.google.com/u/0/d/177h17kYoQEE5jI94Y7EjlS_8exZD9S18=w1280-h528-iv1" /></a></li>
					...
					<div class="details col-md-7">
						<h3 class="product-title">Wicker</h3>
						<div class="variation">
							  <h4>Variations</h2>
						...
						<div class="action">
							<button type="button" class="btn btn-success add-to-cart" data-product="Wicker" id="enquiryProduct" data-toggle="modal" data-target="#myModal">Enquiry</button>
