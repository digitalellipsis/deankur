				...
				<div class="wrapper row">
					<div class="preview col-md-5">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="https://lh3.google.com/u/0/d/1WffC_Yd2XoHOzrpB0EIW9prhkdeIHuCn=w1366-h608-iv1" /></div>

						  
						</div>
						<ul class="preview-thumbnail nav nav-tabs">
						  <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="https://lh3.google.com/u/0/d/1WffC_Yd2XoHOzrpB0EIW9prhkdeIHuCn=w1366-h608-iv1" /></a></li>
					...
					<div class="details col-md-7">
						<h3 class="product-title">Grace</h3>
						<div class="variation">
							  <h4>Variations</h2>
						...
						<div class="action">
							<button type="button" class="btn btn-success add-to-cart" data-product="Grace" id="enquiryProduct" data-toggle="modal" data-target="#myModal">Enquiry</button>
